...
Ten criteria are unattempted `[ ]` — ISC-414..ISC-417, ISC-419, ISC-421, ISC-423 and
ISC-426..ISC-428, from the block ISC-401..ISC-428 filed 2026-09-01 as the done-condition for per-worker inference
...
sides — `400/419` counts the live set, and the frontmatter's `retired: 2` says where the rest
